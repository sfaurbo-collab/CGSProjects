...
void ModifyRectangleTwo(RectangleTwo& y)
{
	y.width = 9;
	y.height = 4;
	std::cout << "The modified width of the second rectangle is " << y.width << " and the height is " << y.height << "." << std::endl;
}

int Area(int w, int h)
{
	int rectangleArea = w * h;
...
int main()
{
	...
	Area(rectangleA.width, rectangleA.height);
}